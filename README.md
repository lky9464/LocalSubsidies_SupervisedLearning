...
[![Release v0.6.0](https://img.shields.io/github/v/tag/lky9464/LocalSubsidies_SupervisedLearning?label=v0.6.0)](https://github.com/lky9464/LocalSubsidies_SupervisedLearning/releases/tag/v0.6.0)
...
온라인에서는 **[Release v0.6.0](https://github.com/lky9464/LocalSubsidies_SupervisedLearning/releases/tag/v0.6.0) 한곳**에서 소스·wheels·UI·Python·VC++까지 받은 뒤 USB로 옮김.  
(학습·추론 raw CSV는 사용자가 별도 준비. Node.js·개발 환경 불필요.)

### A. 온라인 PC에서 받을 것 (USB에 복사)

모두 같은 [Release v0.6.0](https://github.com/lky9464/LocalSubsidies_SupervisedLearning/releases/tag/v0.6.0) Assets / Source:
...
1. USB: Release **`update-to-vX.Y.Z.zip`** 을 프로젝트 루트에 복사 (**zip은 풀지 않음**)  
   - **v0.6.0 기준**: deps 변경 없음 — **`wheels-win-amd64-py312.zip`** 은 최초 설치·v0.5.2 hop 시에만 필요
...
Release 노트: [v0.6.0](https://github.com/lky9464/LocalSubsidies_SupervisedLearning/releases/tag/v0.6.0)
